...
public class InvalidSetterTypeException extends FieldAccessorException {
	...
	public InvalidSetterTypeException(String accessor, AnnotatedElementDescription method, String currentParameterType, String expectedParameterType) {
	...
	public InvalidSetterTypeException(String msg, Exception excp, String accessor, AnnotatedElementDescription method, String currentParameterType, String expectedParameterType) {
